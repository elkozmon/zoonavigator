...
ZooKeeper versions 3.4.x and 3.5.x are currently supported, however it's [been reported](https://github.com/elkozmon/zoonavigator/issues/72#issuecomment-2297821340) to be compatible with up to 3.9.x.
